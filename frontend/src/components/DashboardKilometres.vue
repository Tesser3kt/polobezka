...
const colNumber = computed(() => {
  if (props.teamKm && props.classKm) return 4
  if (props.teamKm || props.classKm) return 3
  return 2
})
</script>
<template>
    ...
    <div class="dashboard-card card">
      ...
      <div class="card-body">
        <div class="container-fluid py-2">
          <div class="row row-cols-2 row-gap-4" :class="`row-cols-sm-${colNumber}`">
            ...
            <div v-if="teamKm" class="col d-flex flex-column justify-content-center">
            ...
            <div v-if="classKm" class="col d-flex flex-column justify-content-center">
